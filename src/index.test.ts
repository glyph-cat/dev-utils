...
// NOTE: For some lines, the 'quotes' rule is disabled because it is easier
// to write the expected output this way

describe('devPrintOnce', () => {
...
describe('displayObjPath', () => {

  it('No items', () => {
    const path = []
    const output = displayObjPath(path)
    expect(output).toBe('``')
  })
